...
export const extractColors = () => {
  try {
    // Get all tokens
    const tokens =
      json.data.tokens["40b949f1-5800-4025-8395-ed22bd52ccc6"].color;
...
const getDefaultColors = () => [
  {
    value: "background_main_surface",
    label: "Background Main Surface",
    category: "BACKGROUND",
  },
  {
    value: "background_main_container",
    label: "Background Main Container",
    category: "BACKGROUND",
  },
  ...
  {
    value: "border_main_default",
    label: "Border Main Default",
    category: "BORDER",
  },
  {
    value: "button_filled_style_3_surface_default",
    label: "Button Filled Style 3 Surface Default",
    category: "BUTTON",
  },
  {
    value: "button_filled_style_3_text_default",
    label: "Button Filled Style 3 Text Default",
    category: "BUTTON",
  },
];
