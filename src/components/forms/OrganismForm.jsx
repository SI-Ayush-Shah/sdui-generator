...
// Stack options for organism layout
const STACK_OPTIONS = [
...
// Component type options for composition
          ...
          <div className="bg-background_main_container rounded-lg shadow-xl w-full max-w-2xl max-h-[80vh] overflow-hidden">
            <div className="p-4 border-b border-border_main_default bg-background_main_card">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-medium text-text_main_high">Select Component</h3>
                <button
                  type="button"
                  ...
                  <div className="text-center py-8 text-text_main_medium">
                    ...
                    {searchTerm ? (
                      ...
                      <p className="text-xs mt-1">
                        Create {selectedComponentType}s first to add them to your organism
                      </p>
                    )}
                  </div>
                )}
