...
const OrganismBuilder = ({ onAdd, handleAddComponent, existingOrganisms, existingMolecules, onUpdate, inline = false }) => {
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex space-x-2">
          ...
          {existingOrganisms.length > 0 && (
            <select
              onChange={(e) => {
                const selected = existingOrganisms.find(o => o.id === e.target.value);
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    value={organism.name}
                    onChange={(e) => setOrganism({...organism, name: e.target.value})}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setOrganism(prev => ({
                      ...prev,
                      properties: { ...prev.properties, position: e.target.value }
                    }))}
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                  >
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                ...
                <TokenSelect
                  ...
                  onChange={(value) => handleStyleChange('border_radius', value)}
                  label="Border Radius"
                />
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                {organism.composition?.map((item, index) => {
                  const component = item.component_type === 'organism' 
                            ...
                            onChange={(e) => {
                              setOrganism(prev => ({
                                ...
                                composition: prev.composition.map((comp, i) =>
                                  i === index ? { ...comp, visibility: e.target.checked } : comp
                                )
                              }));
                            }}
        ...
        <ComponentSelectionModal
          ...
          onCreateNew={
            <div className="space-y-4">
              <div>
                <h4 className="font-medium text-gray-700 mb-2">Create New Organism</h4>
                <OrganismBuilder
              ...
              <div>
                <h4 className="font-medium text-gray-700 mb-2">Create New Molecule</h4>
                <MoleculeBuilder
